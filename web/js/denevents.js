    ...
    $scope.displayEventTypes=function(){
        if(validate($scope.eventTypeArray)){
            ...
            for(var i=0;i<eventTypes.length;i++){
                ...
                text+='<div class="col-sm-4"><div style="background:#ffffff url('+typeImage+') center;-webkit-background-size:cover;-moz-background-size:cover;background-size:cover;"><h2 class="text-center" style="position:relative;top:60px;">'+typeName+'</h2></div></div>';
            }
            text+='</div>';
