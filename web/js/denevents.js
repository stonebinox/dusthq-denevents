    ...
    $scope.displayEvents=function(){
        if(validate($scope.eventsArray)){
            ...
            for(var i=0;i<events.length;i++){
                ...
                text+='<div class="col-md-4"><div class="thumbnail"><a href="event/'+eventID+'"><img src="'+eventImage+'" alt="'+eventName+'" style="width:100%"><div class="caption"><p>'+eventName+'</p></div></a></div></div>';
            }
            text+='</div>';
            $("#eventlist").html(text);
        }
    ...
    $scope.displayEventTypes=function(){
        if(validate($scope.eventTypeArray)){
            ...
            for(var i=0;i<eventTypes.length;i++){
                ...
                text+='<div class="col-sm-4"><div style="width:100%;height:150px;overflow:none;background:#000000;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;"><h2 class="text-center" style="position:relative;top:30px;">'+typeName+'</h2></div></div>';
            }
            text+='</div>';
