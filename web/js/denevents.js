    ...
    $scope.displayEventTypes=function(){
        if(validate($scope.eventTypeArray)){
            ...
            for(var i=0;i<eventTypes.length;i++){
                ...
                text+='<div class="col-sm-4"><div style="width:100%;height:150px;overflow:none;background:#000000;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;"><h2 style="position:relative;top:20px;">'+typeName+'</h2></div></div>';
            }
            text+='</div>';
