    ...
    $scope.displayEventTypes = function() {
        if (validate($scope.eventTypeArray)) {
            ...
            for (var i = 0; i < eventTypes.length; i++) {
                ...
                text+='<div><div class="card lis-brd-light text-center text-lg-left lis-info lis-relative"><a href="#"><div class="lis-grediant grediant-tb-light lis-relative modImage rounded"><img src="'+typeImage+'" alt="'+typeName+'" class="img-fluid rounded" /></div></a><div class="hover-text lis-absolute lis-left-20 lis-bottom-20 lis-font-roboto text-white text-left"><h6 class="text-white mb-0">'+typeName+'</h6><span class="lis-font-roboto">13 listing</span></div></div></div>';
