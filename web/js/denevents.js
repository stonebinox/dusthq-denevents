    ...
    $scope.displayEvents=function(){
        if(validate($scope.eventsArray)){
            ...
            for(var i=0;i<events.length;i++){
                ...
                text+='<div class="col-md-4"><div class="thumbnail"><a href="event/'+eventID+'"><img src="'+eventImage+'" alt="'+eventName+'" style="width:30%"><div class="caption"><p>'+eventName+'</p></div></a></div></div>';
            }
            text+='</div>';
            $("#eventlist").html(text);
        }
