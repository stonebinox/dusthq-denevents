    ...
    $scope.displayEventTypes=function(){
        if(validate($scope.eventTypeArray)){
            ...
            for(var i=0;i<eventTypes.length;i++){
                ...
                text+='<div class="col-sm-4"><div style="width:100%;height:150px;overflow:none;background:#000000;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;"><div style="margin-top:20px;"><h2 class="text-center">'+typeName+'</h2></div></div></div>';
            }
            text+='</div>';
